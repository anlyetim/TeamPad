...
const saveToStorage = (id, data)=>{
    if ("TURBOPACK compile-time truthy", 1) {
        localStorage.setItem(`haloboard_project_${id}`, JSON.stringify(data));
    }
};
const loadFromStorage = (id)=>{
    if ("TURBOPACK compile-time truthy", 1) {
        const data = localStorage.getItem(`haloboard_project_${id}`);
...
//# sourceMappingURL=_4cbad3dc._.js.map
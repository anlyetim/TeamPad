...
function Canvas() {
    ...
    const { objects, layers, activeTool, setActiveTool, brushSettings, shapeSettings, canvasSettings, activeLayerId, zoom, panX, panY, isPanning, selectedIds, addObject, updateObject, deleteObject, setIsPanning, setPan, setSelectedIds, showGrid, showTransformHandles, highlightColor, setZoom, copy, paste, duplicate, keybindings } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHaloboardStore"])();
...
_s(Canvas, "/APTgj2spviR/srbSyx4GEdIn3U=", false, function() {
    return [
...
//# sourceMappingURL=_e0634ea6._.js.map